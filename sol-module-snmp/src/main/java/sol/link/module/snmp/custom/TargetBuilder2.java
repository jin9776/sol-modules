...
public class TargetBuilder2<A extends Address>{
    ...
    public TargetBuilder2<A>.DirectUserBuilder user(String securityName) {
        return this.user((String)securityName, (byte[])null);
    }

    public TargetBuilder2<A>.DirectUserBuilder user(String securityName, byte[] authoritativeEngineID) {
        return this.user(new OctetString(securityName), authoritativeEngineID);
    }

    public TargetBuilder2<A>.DirectUserBuilder user(OctetString securityName) {
        return this.user((OctetString)securityName, (byte[])null);
    }

    public TargetBuilder2<A>.DirectUserBuilder user(OctetString securityName, byte[] authoritativeEngineID) {
        this.snmpVersion = TargetBuilder.SnmpVersion.v3;
        return new TargetBuilder2.DirectUserBuilder(securityName, authoritativeEngineID);
    }

    public TargetBuilder2<A>.TlsTargetBuilder tls(String identity) {
        return this.tls(new OctetString(identity));
    }

    public TargetBuilder2<A>.TlsTargetBuilder tls(OctetString identity) {
        return new TargetBuilder2.TlsTargetBuilder(identity);
    }

    public TargetBuilder2<A>.TlsTargetBuilder dtls(String identity) {
        return this.dtls(new OctetString(identity));
    }

    public TargetBuilder2<A>.TlsTargetBuilder dtls(OctetString identity) {
        return new TargetBuilder2.TlsTargetBuilder(identity);
    }
    ...
    public class DirectUserBuilder {
        ...
        private TargetBuilder2.PrivProtocol2 privacyProtocol;
        ...
        public TargetBuilder2<A>.DirectUserBuilder auth(TargetBuilder.AuthProtocol authenticationProtocol) {
            this.authenticationProtocol = authenticationProtocol;
            return this;
        }

        public TargetBuilder2<A>.DirectUserBuilder priv(TargetBuilder2.PrivProtocol2 privacyProtocol) {
            this.privacyProtocol = privacyProtocol;
            return this;
        }

        public TargetBuilder2<A>.DirectUserBuilder authPassphrase(String authPassword) {
            return this.authPassphrase(OctetString.fromString(authPassword));
        }

        public TargetBuilder2<A>.DirectUserBuilder authPassphrase(OctetString authPassword) {
            this.authPassword = authPassword;
            return this;
        }

        public TargetBuilder2<A>.DirectUserBuilder privPassphrase(String privPassword) {
            return this.privPassphrase(OctetString.fromString(privPassword));
        }

        public TargetBuilder2<A>.DirectUserBuilder privPassphrase(OctetString privPassword) {
    ...
    public class TlsTargetBuilder {
        ...
        public TargetBuilder2<A>.TlsTargetBuilder serverFingerprint(OctetString fingerprint) {
            this.serverFingerprint = fingerprint;
            return this;
        }

        public TargetBuilder2<A>.TlsTargetBuilder clientFingerprint(OctetString fingerprint) {
            this.clientFingerprint = fingerprint;
            return this;
        }

        public TargetBuilder2<A>.TlsTargetBuilder securityCallback(TlsTmSecurityCallback<X509Certificate> tlsTmSecurityCallback) {
    ...
    public static enum PrivProtocol2 {
        des("DES", PrivDES.ID),
