...
public class PrivAES192C extends PrivAESWith3DESKeyExtension implements NonStandardSecurityProtocol {
    @Serial
    private static final long serialVersionUID = -4678800188622949126L;
    ...
    static {
        ID = new OID(new int[]{1, 3, 6, 1, 4, 1, 9, 12, 6, 1, 1});
    }
}
